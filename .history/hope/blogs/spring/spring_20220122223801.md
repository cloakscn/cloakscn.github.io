...
|:-|-:|
|1. 实体类与表<br/>2. 业务层接口与实现<br/>3. 数据层接口<br/>4. Mybatis 核心配置<br/>5. Mybatis 映射配置<br/>6. 客户端程序测试功能|1. 实体类与表<br/>2. 业务层接口与实现（提供数据层接口的注入操作）<br/>3. 数据层接口<br/>4. Mybatis 核心配置（交给 spring 控制，该文件省略）<br/>5. Mybatis 映射配置<br/>6. 客户端程序测试功能（使用 spring 方式获取 bean）<br/>
